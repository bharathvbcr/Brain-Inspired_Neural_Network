...
- protocol: `binn-hybrid-diagnostic-v1-4cb61b5dabf3fec8`
- schedule: **PILOT**
- seeds: 3
- budgets: [60, 240]
...
> Development-only diagnostics. Frozen H0 protocol v3 remains `HYBRID_NO_GO`; these sweeps cannot reverse it and use no fresh held-out seeds. The privileged arm receives true intermediate states and is a harness ceiling, not an admissible learner.
...
| direct-terminal | 3 |
| privileged-intermediate-target | 1 |
| shuffled-label | none |
...
|---:|---|---:|---:|
| 1 | privileged-intermediate-target | 0.8063 | 0.6940 |
| 1 | shuffled-label | 0.0000 | 0.0000 |
| 2 | privileged-intermediate-target | 0.3146 | 0.1904 |
| 2 | shuffled-label | 0.0771 | 0.0300 |
| 3 | privileged-intermediate-target | 0.2354 | 0.1883 |
| 3 | shuffled-label | 0.1396 | 0.1218 |
| 4 | privileged-intermediate-target | 0.2708 | 0.2414 |
| 4 | shuffled-label | 0.1958 | 0.1526 |
| 5 | privileged-intermediate-target | 0.3083 | 0.2361 |
| 5 | shuffled-label | 0.2021 | 0.1687 |
| 6 | privileged-intermediate-target | 0.3312 | 0.3067 |
| 6 | shuffled-label | 0.2417 | 0.1845 |
| 7 | privileged-intermediate-target | 0.2812 | 0.2138 |
| 7 | shuffled-label | 0.2896 | 0.2628 |
| 8 | privileged-intermediate-target | 0.2562 | 0.2188 |
| 8 | shuffled-label | 0.2521 | 0.2050 |
