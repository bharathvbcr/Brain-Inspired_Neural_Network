...
- protocol: `binn-hybrid-h0-v3-caedeec1a47475a5`
- schedule: PILOT
...
Thresholds: C1 accuracy 0.650; C3 accuracy 0.650; teacher D* ≥ 6; student D* ≥ 6. Normalized gap is not evaluated by this surrogate; it requires the production matched-dense protocol (target 0.500).
