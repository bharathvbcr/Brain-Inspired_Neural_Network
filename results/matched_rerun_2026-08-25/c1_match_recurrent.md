...
|---|---:|---:|
| `MATCHED_ARCH_LOCAL_THREE_FACTOR` (broadcast three-factor) | 0.5100 | 0.002000 |
| `MATCHED_ARCH_GRADIENT_CEILING` (SuperSpike BPTT ceiling) | 1.0000 | 0.000000 |

- `gap_closed_matched` mean: **0.0200**  (var 0.008000)
- lower 95% CB (z=1.96): **-0.0192**  (needs > 0.50)
...
| 4354473785401079851 | 0.5000 | 1.0000 | 0.0000 |
...
| 7681299373375738109 | 0.5000 | 1.0000 | 0.0000 |
| 635552697772690704 | 0.5000 | 1.0000 | 0.0000 |
| 12035986003464472871 | 0.7000 | 1.0000 | 0.4000 |
...
| 13699608533723985294 | 0.5000 | 1.0000 | 0.0000 |
