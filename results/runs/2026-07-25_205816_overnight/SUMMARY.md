# Overnight run summary — 2026-07-25_205816

Run dir: `results/runs/2026-07-25_205816_overnight`
...
| smoke_c1_enhanced | ok | 1 |
| smoke_multi_area | ok | 1 |
...
3. Tier 2+ is `pending`; this smoke run is not the decisive result.
   ...
   ```bash
   grep -rn 'INVALID_HARNESS\|DEGENERATE\|INVERTED\|LEAK DETECTED\|MISMATCH' results/runs/2026-07-25_205816_overnight/*.md
   ```
