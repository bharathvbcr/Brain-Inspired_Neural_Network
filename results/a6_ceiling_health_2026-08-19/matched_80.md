...
**Verdict: no budget tested lifts the reference above the arm.** Best is `e80/lr0.05` at 0.9013, still below the MatchedDfa arm's 0.9387. On this evidence the published 0.8963 is not simply undertrained — but note this is a bounded sweep, not a proof of convergence.
...
**Verdict: no budget tested lifts the reference above the arm.** Best is `e80/lr0.05` at 0.9188, still below the MatchedRlReinforceFb arm's 0.9200. On this evidence the published 0.8887 is not simply undertrained — but note this is a bounded sweep, not a proof of convergence.
