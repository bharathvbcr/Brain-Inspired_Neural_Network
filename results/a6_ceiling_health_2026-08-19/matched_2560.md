...
- seeds: **20** · arm budget (fixed): **2560 epochs** · canonical reference budget: **e80/lr0.05**
...
| `e2560/lr0.05` | 1.0000 | 0.0000 | arm above | control above |

**Harness check: reproduces.** Canonical row 0.9013 vs published 0.8963 (drift 0.0050).

**Verdict: no budget tested lifts the reference above the arm.** Best is `e2560/lr0.05` at 1.0000, still below the MatchedDfa arm's 1.0000. On this evidence the published 0.8963 is not simply undertrained — but note this is a bounded sweep, not a proof of convergence.
...
- MatchedRlFlat (±1 baseline) (fixed): **0.5638**

| reference budget | reference mean | SE | vs arm | vs control |
|---|---|---|---|---|
| `e80/lr0.05` *(canonical)* | 0.9188 | 0.0263 | arm above | **reference above** |
| `e2560/lr0.05` | 1.0000 | 0.0000 | arm above | **reference above** |
...
**Verdict: no budget tested lifts the reference above the arm.** Best is `e2560/lr0.05` at 1.0000, still below the MatchedRlReinforceFb arm's 1.0000. On this evidence the published 0.8887 is not simply undertrained — but note this is a bounded sweep, not a proof of convergence.
